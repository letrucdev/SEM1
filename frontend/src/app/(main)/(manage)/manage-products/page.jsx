...
import { ArrowDownWideNarrow, ArrowUpWideNarrow, ShoppingBasket } from 'lucide-react'
...
export default function ManageProductsPage() {
    ...
    const { isPendingGetProductCategories, productCategories } = useGetProductCategories()
