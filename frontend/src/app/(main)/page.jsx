...
export default function HomePage() {
	return (
		<>
			<div className='flex flex-col min-h-screen bg-white gap-11'>
				{/* Hero Section */}
				<div className='relative flex items-center justify-center overflow-hidden w-full h-[600px] mt-6 px-6'>
					...
					{/* 	<div className='w-full p-0 m-0 h-full max-w-[1920px] relative overflow-hidden '></div> */}
				</div>
				...
				{/* Services Section */}
				<div className='bg-white container mx-auto px-6 pt-12'>
				...
				<div className='bg-white pt-16 container mx-auto px-6'>
					<div className='text-center mb-8'>
						...
						<Button className='px-10 py-2 font-semibold'>Meet More</Button>
					</div>
					<div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6'>
						{[
							...
							<DentistCard key={index} dentist={dentist} />
						))}
					</div>
				</div>
