...
export default function ProfressionalDocuments() {
	...
	const { posts, postTotal, isPendingGetPosts } = useGetPosts({
		...pagination,
		...filters,
		postType: POST_TYPE.ProfressionalDocument,
	})
			...
			<div className='flex flex-col w-full gap-4'>
				<Breadcrumb>
					<BreadcrumbList>
						...
						<BreadcrumbSeparator />
						<BreadcrumbItem>
							<BreadcrumbPage href='/education/profressional-documents'>
								Profressional Documents
							</BreadcrumbPage>
						</BreadcrumbItem>
					</BreadcrumbList>
				</Breadcrumb>
